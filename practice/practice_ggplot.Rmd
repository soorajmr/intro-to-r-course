...
You might want to arrange the bars in increasing or decreasing order of mileage for better readability. We can do that in the aesthetics of geom_bar by specifying `x = reorder(car, mpg)`. Try it below.
...
We have only scratched the surface of what is possible with ggplot. If you would like to continue playing around with this data set and practice more ggplot features, this book chapter (freely available online) is a great resource: https://r4ds.had.co.nz/data-visualisation.html
