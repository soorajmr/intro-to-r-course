...
## saveGIF is not working for some reason. We'll save the png's and convert them to GIF using Imagemagick.
...
Here is the generated GIF file (to see the animation, refresh the page or open the image in a new window/tab on the browser)  

<br/>
![Megacities](images/megacities_evolution.gif)
